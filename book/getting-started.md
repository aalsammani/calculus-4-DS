...
This page takes care of two practical matters before the mathematics begins: setting up Python, and learning to read the book's visual conventions.
...
:class: seealso
These panels point to where an idea reappears in later sections, chapters, or later courses, so you know which investments pay off where.
```
