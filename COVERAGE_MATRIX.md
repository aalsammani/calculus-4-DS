# Coverage Matrix —  Syllabus ↔ Textbook

Every topic on the  (Calculus and Matrix Fundamentals) syllabus, mapped to the chapters and sections that teach it. Reference texts on the syllabus: OpenStax Calculus Vols. 1–3, Goodfellow et al. Ch. 2, Strang.
...
| **Functions of several variables; limits** | Ch. 22 §6.2.1 | Surfaces, contour maps, path-dependence of limits |
| **Partial derivatives** | Ch. 22 §6.2.2 | Higher/mixed partials, Clairaut, Hessian |
| **Multivariable chain rule** | Ch. 22 §6.2.4 | One-term-per-path form; backpropagation connection |
